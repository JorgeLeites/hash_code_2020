...
with open(f'{file_name}.in') as f:
    ...
    for i in range(number_of_libraries):
        ...
        books_library_can_process = min((max_days - days_to_finish_signup) * books_shipped_per_day, number_of_books_in_library)
        
        score = sum(books_in_library[0:books_library_can_process])
